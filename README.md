...
`main` is preparing `v1.2.1`. The latest stable release is `v1.2.0`.
...
The examples below use the current `v1.2.0` asset contract. Replace `v1.2.0` with the release tag you are installing.

Available release assets:

- Ubuntu / WSL x64: `distill-v1.2.0-linux-x64`
- macOS Intel: `distill-v1.2.0-macos-x64.zip`
- macOS Apple Silicon: `distill-v1.2.0-macos-arm64.zip`
- Windows PowerShell 7 x64: `distill-v1.2.0-windows-x64.exe`
...
2.  Make the binary executable (macOS/Linux): `chmod +x distill-v1.2.0-macos-arm64` (example).
3.  Run the CLI: `./distill-v1.2.0-macos-arm64 spec.pdf`
